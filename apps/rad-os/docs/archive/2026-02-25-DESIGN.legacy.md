...
| `--color-depth` | black (5% opacity) | cream (5% opacity) |
| `--color-hover` | black (10% opacity) | cream (10% opacity) |

#### Overlay Tokens

| Token | Sun Mode | Moon Mode |
|-------|----------|-----------|
| `--color-hover` | black (5% opacity) | cream (8% opacity) |
| `--color-active` | black (10% opacity) | cream (12% opacity) |
