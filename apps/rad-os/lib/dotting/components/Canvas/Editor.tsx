// @ts-nocheck — vendored canvas engine; strict null checks deferred
...
export default class Editor extends EventDispatcher {
  ...
  styleMouseCursor = (mouseCoord: Coord) => {
    ...
    let hoveredButton: ButtonDirection | null = this.detectButtonClicked(mouseCoord);
  ...
  renderAll() {
    ...
    if (this.renderDataLayerTimeout) clearTimeout(this.renderDataLayerTimeout);
