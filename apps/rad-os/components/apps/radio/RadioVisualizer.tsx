...
export function RadioVisualizer({ currentTime, duration, className = '' }: RadioVisualizerProps) {
  ...
  return (
    <div
      ...
      style={{
        // eslint-disable-next-line rdna/no-hardcoded-colors -- reason:paper-design-lcd-strip owner:rad-os expires:2026-12-31 issue:DNA-999
        backgroundColor: 'oklch(0 0 0)',
        // eslint-disable-next-line rdna/no-hardcoded-colors -- reason:paper-design-yellow-outline owner:rad-os expires:2026-12-31 issue:DNA-999
        ...
        return (
          <span
            ...
            style={{
              ...
              backgroundColor: isLit ? 'oklch(1 0 0)' : 'oklch(1 0 0 / 0.06)',
              boxShadow: isLit
