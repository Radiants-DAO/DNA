...
function YellowlistContent() {
  return (
    <div className="space-y-6">
      <div>
        <h3 className="mb-2">Permanent Inclusions</h3>
        <p className="mb-4">
            ...
            <div className="relative w-full aspect-square border border-edge-primary rounded-sm overflow-hidden bg-surface-primary">
              ...
              <div className="absolute inset-0 bg-edge-muted flex justify-end items-start p-1 gap-1 opacity-0 hover:opacity-100 transition-opacity">
                <a
                  ...
                  className="w-6 h-6 border border-edge-primary bg-surface-elevated rounded flex items-center justify-center hover:bg-sun-yellow transition-colors"
