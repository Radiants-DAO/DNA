...
- **Checklist**: `/Users/rivermassey/Desktop/dev/DNA/docs/ops/paper/paper-social-graphics-checklist.md`
...
```
Read docs/ops/paper/prompts/LEARNINGS.md, then docs/ops/paper/paper-social-graphics-checklist.md.
