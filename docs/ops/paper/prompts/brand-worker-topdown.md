...
1. Read `docs/ops/paper/prompts/LEARNINGS.md` — apply any rules that affect your current item.
...
7. **Log learnings** — if you hit any gotcha, append to `docs/ops/paper/prompts/LEARNINGS.md`.
