...
> Pre-computed CSS `background-image` values for all 51 RDNA bitmap patterns.
> 
> Default fill color: `#0F0E0C` (ink). Agents swap the hex literal as needed.
> 
> Source: `packages/radiants/patterns/registry.ts`
