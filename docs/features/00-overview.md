...
| [Canvas Editor](./08-canvas-editor.md) | System-level view, multi-select, layers panel |
| [AI Integration](./09-ai-integration.md) | Prompt builder, prompt library, SREF codes |
| [Tauri Architecture](./10-tauri-architecture.md) | Rust backend specification, migration path |
| [Mock States](./11-mock-states.md) | Development state simulation, useMockState hook |
