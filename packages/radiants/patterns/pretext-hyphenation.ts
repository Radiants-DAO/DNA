...
const HYPHEN_EXCEPTIONS: Record<string, string[]> = {
  ...
  // Manifesto long words (10+ chars, high hyphenation impact)
  'catastrophically': ['cat','a','stroph','i','cal','ly'],
  'differentiator': ['dif','fer','en','ti','a','tor'],
  'technologists': ['tech','nol','o','gists'],
  ...
  'accelerated': ['ac','cel','er','at','ed'],
  'cryptocurrency': ['cryp','to','cur','ren','cy'],
  'unpredictable': ['un','pre','dict','a','ble'],
  'masturbatory': ['mas','tur','ba','to','ry'],
