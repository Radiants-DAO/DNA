...
interface TabTriggerProps {
  ...
  /** Tab label */
  children: React.ReactNode;
  /** Icon name (filename without .svg extension) - loads from public/assets/icons/ */
  iconName?: string;
  /** Icon as React element (alternative to iconName) */
...
export function TabTrigger({
  ...
  return (
    <button
      ...
      className={classes}
    >
      {/* Render icon from React component or SVG name - icon comes first to match PrimaryNavigationFooter */}
      {icon ? (
        icon
      ) : iconName ? (
