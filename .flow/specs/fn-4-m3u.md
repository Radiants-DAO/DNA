...
| **V** | Select/Prompt | Build linear prompt with element selections | Phase 2 |
...
3. **Mid-edit blocking** - cannot switch modes while contenteditable is active
...
4. **Esc always exits** - from any mode, returns to Cursor
...
- **Page reload during edit**: Persist to localStorage, prompt "Recover or discard?" on return
