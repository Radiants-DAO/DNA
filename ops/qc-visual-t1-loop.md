...
- **Checklist**: `/Users/rivermassey/Desktop/dev/DNA/ops/qc-visual-t1-checklist.md`
...
Read `ops/qc-visual-t1-checklist.md`. Find the FIRST `[ ]` item. That is your target for this iteration.
...
In `ops/qc-visual-t1-checklist.md`, update the item:
