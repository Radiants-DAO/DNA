...
- **Checklist**: `/Users/rivermassey/Desktop/dev/DNA/ops/paper-loop-prompts/../paper-brand-manual-checklist.md`
...
- **Pattern Data**: `/Users/rivermassey/Desktop/dev/DNA/ops/paper-loop-prompts/pattern-data-uris.md`
...
```
Read ops/paper-loop-prompts/LEARNINGS.md for any rules, then read ops/paper-brand-manual-checklist.md.
Find the FIRST [ ] item. Do ONE item only.

Read ops/paper-brand-brief.md for resolved values. For patterns, read ops/paper-loop-prompts/pattern-data-uris.md.
...
Log any gotchas to ops/paper-loop-prompts/LEARNINGS.md.
...
```
Read ops/paper-loop-prompts/LEARNINGS.md, then read ops/paper-brand-manual-checklist.md.
...
Check against ops/paper-brand-brief.md:
...
Log systemic issues to ops/paper-loop-prompts/LEARNINGS.md.
