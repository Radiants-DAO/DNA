...
// ============================================================================
// Checkbox Component — Inset variation
// Recessed, inset-shadow treatment for a pressed-into-surface feel
// Uses surface-muted bg with inset shadow, accent fill slides in on check
// ============================================================================
...
export function Checkbox({
  ...
  return (
    ...
    >
          ...
          <span
            ...
            className={`
              ...
              ${state.checked || state.indeterminate
                ...
                : 'bg-surface-muted shadow-inset hover:border-line-hover'
              }
            `}
          />
        )}
      ...
      {label && (
        <span className="text-sm text-sub select-none uppercase tracking-wide">
          {label}
        </span>
      )}
    </label>
...
// ============================================================================
// Radio Component — Inset variation
// ============================================================================
  ...
  const radioRoot = (
    ...
    >
      <BaseRadio.Indicator className="flex items-center justify-center">
        <div className="w-2.5 h-2.5 bg-accent-inv rounded-full" />
      </BaseRadio.Indicator>
    </BaseRadio.Root>
  );
