/**
 * Spatial Viewport Slice - Ported from Flow 0
 *
 * Manages state for the spatial file browser canvas.
 */
...
/**
 * Merge children into file tree at path
 */
