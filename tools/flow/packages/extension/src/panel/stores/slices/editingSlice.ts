/**
 * Editing Slice - Ported from Flow 0
 *
...
> = (set, get) => ({
  ...
  // WARNING: Set is not JSON-serializable. If this slice needs persistence,
  // convert to array-based storage (string[]) and use new Set(arr) / [...set] for conversion.
  selectedIds: new Set(),
