...
const GAP = 48; // gap between component grid and page preview
 ...
 *
 * Positioned to the right of component nodes by default, draggable.
 * Includes viewport presets for desktop/mobile sizes with orientation toggle.
 */
export function PagePreviewCard({ componentsRight }: PagePreviewCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Drag grip */}
        <svg width="8" height="14" viewBox="0 0 8 14" className="text-white/20 flex-shrink-0">
