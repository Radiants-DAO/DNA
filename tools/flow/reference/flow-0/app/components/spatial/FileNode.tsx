...
export function FileNode({
  ...
  if (node.isTruncationNode) {
    return (
      <div
        ...
        tabIndex={0}
        className="file-node-truncation absolute flex items-center gap-2 px-3 py-2 rounded-lg cursor-pointer text-content-muted"
        style={{
          left: node.x,
          top: node.y,
          width: node.width,
  ...
  return (
    ...
    >
      ...
      {/* File/folder icon */}
      <Icon size={16} className="text-content-muted flex-shrink-0" />
