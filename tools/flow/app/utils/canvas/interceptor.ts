 ...
 *
 * Ported from Webstudio's interceptor.ts with adaptations for RadFlow:
...
/**
 * Events that should be intercepted in design mode.
 */
const INTERCEPTED_EVENTS = [
  "submit",       // Form submissions
  "reset",        // Form resets
  "input",        // Input changes (for controlled inputs)
] as const;
...
export function applyPointerEventsStyle(doc: Document, mode: InterceptorMode): void {
  const styleId = "radflow-interceptor-styles";
